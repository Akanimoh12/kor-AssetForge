...
type FeeDiscountTier struct {
	...
	MinVolumeStroops    datatypes.JSONType `gorm:"type:numeric" json:"min_volume_stroops"`
	MaxVolumeStroops    datatypes.JSONType `gorm:"type:numeric" json:"max_volume_stroops"`
